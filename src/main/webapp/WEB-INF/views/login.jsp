...
<!-- 				<p class="text-danger">error:failed to login</p> -->
				<form:form modelAttribute="loginForm" action="${pageContext.request.contextPath}/authenticate" method="POST">
		...
		<div>
			<a type="button" class="btn btn-default" href="${pageContext.request.contextPath}/register/toRegisterUser">
			<i class="fa fa-user-plus"></i>&nbsp;Register Account</a>
		</div>
	</div>
</body>
</html>