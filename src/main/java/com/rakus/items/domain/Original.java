...
public class Original {
	...
	public Original(Integer id, String name, Integer conditionId, String categoryName, String brand, Integer price,
	...
	public String toString() {
		return "Original [id=" + id + ", name=" + name + ", conditionId=" + conditionId + ", categoryName="
				+ categoryName + ", brand=" + brand + ", price=" + price + ", shopping=" + shopping + ", description="
				+ description + "]";
	}
